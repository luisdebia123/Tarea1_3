...
# Faltan algunos detalles pero los agregaremos
...
b=1
c=2
n=int((len(elegir.clientes)/3))
for recorrer  in range(n):
    print("el Nombre de Cliente es  :",elegir.clientes[a],elegir.clientes[b],elegir.clientes[c])
    a=a+3
    b=b+3
    c=c+3
print()
# Se ingresa clientes misma Financiera
elegir.transferir('El Principe','La Princesita',2)

# Se Ingresa tranferencia entre Financiera
f1 = el_prestamo
f2 = el_prestamo_2

f1.Inter_Transferencia(f2,'La Princesita','Rosita',5)
